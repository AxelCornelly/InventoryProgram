...
public class FormController {
    ...
    public void switchSceneTo(String form, Button btn) throws IOException{
        ...
        switch(form) {
            case "addpartform":
                page = (Pane) FXMLLoader.load(getClass().getResource("/UI/addpartform.fxml"));
                stage.setScene(new Scene(page));
                break;
            case "addproductform":
                page = (Pane) FXMLLoader.load(getClass().getResource("/UI/addproductform.fxml"));
                stage.setScene(new Scene(page));
                break;
            case "modifypartform":
                page = (Pane) FXMLLoader.load(getClass().getResource("/UI/modifypartform.fxml"));
                stage.setScene(new Scene(page));
                break;
            case "modifyproductform":
                page = (Pane) FXMLLoader.load(getClass().getResource("/UI/modifyproductform.fxml"));
                stage.setScene(new Scene(page));
                break;
        }
    }
